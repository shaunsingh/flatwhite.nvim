...
theme.loadTreeSitter = function ()
    ...
    local treesitter = {
        ...
        TSConstructor =             { fg = flatwhite.black, bg = flatwhite.cyan},
        ...
        TSField =                   { fg = flatwhite.black, bg = flatwhite.cyan},
        ...
        TSParameter =               { fg = flatwhite.black, bg = flatwhite.cyan},
        ...
        TSString =                  { fg = flatwhite.black, bg = flatwhite.cyan},
        ...
        TSText =                    { fg = flatwhite.text},
        TSTextReference =           { fg = flatwhite.text},
